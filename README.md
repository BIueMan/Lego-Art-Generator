...
5. **update - personal touch**: Let the user to change every pixel in the image, before PDF creation
6. **PDF Creation**: Finally, the program generates a PDF instruction for the Lego art and saves it in the `output/` directory.
...
### From `personal_touch`
- `personal_touch`: This function help you added final personal touch to the image, before pdf is generated
